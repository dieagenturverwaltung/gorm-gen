...
import (
	...
	"github.com/dieagenturverwaltung/gorm-gen/tests/.expect/dal_test_relation/model"
	"github.com/dieagenturverwaltung/gorm-gen/tests/.expect/dal_test_relation/query"
)
